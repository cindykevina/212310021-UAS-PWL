  ...
  useEffect(() => {
    ...
    const fetchUserName = async () => {
      try {
        ...
        // Optionally, store the user's name in session storage
        sessionStorage.setItem("userName", response.data.user.nama);
    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        ...
        <span className="flex items-center gap-2 font-medium text-dark dark:text-dark-6">
          <span className="hidden lg:block">  {userName || "User"}</span>
